...
*/
const generateValueBetweenMinAndMax = (min, max) => min + Math.round(Math.random() * (max - min));

export {
  convertArrayToPagedObject, generateValueBetweenMinAndMax, handleHTTPError, HTTPError,
};
